...
')
     ...
     */ 
        ...
        {
                        /** @var \Ghost\GoogleAuthenticator\Lib\GoogleAuthenticator $instance */
                        return $instance->createSecret($secretLength);
        }
                    /**
        ...
        {
                        /** @var \Ghost\GoogleAuthenticator\Lib\GoogleAuthenticator $instance */
                        return $instance->getCode($secret, $timeSlice);
        }
                    /**
        ...
        {
                        /** @var \Ghost\GoogleAuthenticator\Lib\GoogleAuthenticator $instance */
                        return $instance->getQRCodeGoogleUrl($name, $secret, $title);
        }
                    /**
        ...
        {
                        /** @var \Ghost\GoogleAuthenticator\Lib\GoogleAuthenticator $instance */
                        return $instance->verifyCode($secret, $code, $discrepancy, $currentTimeSlice);
        }
                    /**
        ...
        {
                        /** @var \Ghost\GoogleAuthenticator\Lib\GoogleAuthenticator $instance */
                        return $instance->setCodeLength($length);
        }
...
namespace  { 
            ...
            class GoogleAuthenticator extends \Ghost\GoogleAuthenticator\Facades\GoogleAuthenticator {}
